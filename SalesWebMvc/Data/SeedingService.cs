...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //registro existentes nas tabelas com Any pesquisa na tabela do banco se há o registro
            }
            ...
            _context.Departament.AddRange(d1, d2, d3, d4);//permite que adiciona vários objetos de uma vez
